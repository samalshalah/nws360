...
export default function Feed({ officialSourcesOnly: officialSourcesOnlyProp = false, defaultCategory }: FeedProps = {}) {
  ...
  const [filters, setFilters] = useState(() => {
    ...
    return {
      ...
      sourceId: params.get("sourceId") || undefined as string | undefined,
      ...
      manualTag: params.get("manualTag") || undefined as string | undefined,
      sourceType: params.get("sourceType") || undefined as string | undefined,
      startDate: params.get("startDate") || undefined as string | undefined,
      endDate: params.get("endDate") || undefined as string | undefined,
      dateRange: params.get("dateRange") || "all" as string,
