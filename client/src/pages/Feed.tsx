  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-display font-bold text-foreground">News Feed</h1>
        <p className="text-muted-foreground">Explore curated news from all your configured sources.</p>
      </div>
      ...
      {isLoadingArticles ? (
        ...
        <div className="text-center py-20 bg-muted/30 rounded-3xl border border-dashed border-border">
          ...
          <h3 className="text-xl font-bold font-display text-foreground">No articles found</h3>
